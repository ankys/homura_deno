...
import MarkdownItBracketedSpans from "npm:markdown-it-bracketed-spans@1.0.1"
import MarkdownItAttrs from "npm:markdown-it-attrs@4.1.6"

const mdi = MarkdownIt({ html: true }).use(MarkdownItBracketedSpans).use(MarkdownItAttrs);
